    ...
    <DataTable
      ...
      columns={[
        ...
        },
        {
          ...
          header: "Status",
          render: (_, row) => {
            if (row.unsubscribedAt) return <Badge variant="outline" className="bg-red-50 text-red-700 border-red-200">Descadastrado</Badge>;
            if (row.confirmedAt) return <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200">Confirmado</Badge>;
